...
export default function GadgetsPage() {
  ...
  const { data: featuredArticles, isLoading: isFeaturedLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      console.log('Featured gadgets articles fetched:', data);
      return data || [];
    }
  });
  ...
  const { data: articles, isLoading: isArticlesLoading } = useQuery({
    ...
    queryFn: async () => {
      console.log('Fetching gadgets articles for subcategory:', subcategory);
      const { data, error } = await supabase
        .from('blogs')
        .select('*')
        .eq('category', 'GADGETS')
      ...
      console.log('Fetched gadgets articles:', data);
      return data || [];
    }
  });
